...
project = 'example-cookiecutter-cpp-project'
...
breathe_projects = {}
breathe_default_project = "example-cookiecutter-cpp-project"
...
if read_the_docs_build:
    ...
    breathe_projects["example-cookiecutter-cpp-project"] = os.path.join(builddir, "doc", "xml")
